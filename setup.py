...
setup(
    name="dataCollectionProgressExtension",
    version="1.0",
    ...
    entry_points={
        "climmob.plugins": [
            "dataCollectionProgressExtension = dataCollectionProgressExtension.plugin:dataCollectionProgressExtension"
        ],
        "climmob.tasks": [
            "dataCollectionProgressExtension = dataCollectionProgressExtension.celerytasks"
        ],
    },
)
